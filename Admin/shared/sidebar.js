(function() {
  ...
  const SIDEBAR_HTML = `
    <div class="c-sidebar__brand">
      <a href="../landing_page/landing/index.html" id="j-brand-home-link" style="display: flex; align-items: center; gap: 0.75rem; text-decoration: none; color: inherit; cursor: pointer;">
        ...
        <div class="c-sidebar__brand-text j-collapsible-text">
          ...
          <p class="c-sidebar__brand-subtitle">Administrator</p>
        </div>
      </a>
    ...
    <nav class="c-sidebar__nav" aria-label="Main menu">
      ...
      <ul class="c-sidebar__nav-list j-nav-list">
        ...
        <li>
          <a href="../verify/index.html" class="c-nav-item j-nav-item" data-nav-name="Approvals & Verifications">
            <span class="c-nav-item__pill" aria-hidden="true"></span>
            <span class="c-nav-item__icon" aria-hidden="true"><svg class="c-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="m9 12 2 2 4-4"/></svg></span>
            <span class="c-nav-item__label j-collapsible-text">Approvals & Verifications</span>
          </a>
        </li>
        <li>
          <a href="../audit/index.html" class="c-nav-item j-nav-item" data-nav-name="Audit Logs">
            <span class="c-nav-item__pill" aria-hidden="true"></span>
            ...
            <span class="c-nav-item__label j-collapsible-text">Audit Logs</span>
          </a>
        </li>
      </ul>
    </nav>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (brandLink) {
      brandLink.addEventListener('click', (e) => {
        ...
        if (mainFrame || path.endsWith('/admin/index.html') || path.endsWith('/admin')) {
          window.location.href = 'landing_page/landing/index.html';
        } else {
          window.location.href = '../landing_page/landing/index.html';
        }
      });
