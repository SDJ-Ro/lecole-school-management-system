...
/**
 * =========================================================================
 * L'ÉCOLE — ADMIN ACADEMIC OVERVIEW VIEW
 * =========================================================================
 * Responsibility: Renders the Admin Academic Overview interface.
 * Role: Admin (`/admin/academic`)
 * Architectural Precedent: 1:1 structural port from `Admin/academic/index.html`.
 */

$title = "Academic Overview — L'École Admin";
$featureCss = "/assets/features/admin_academic/styles.css";
$currentRole = 'admin';
...
<div class="c-modal-layer" id="j-modal-confirm-delete" role="presentation">
  <button type="button" class="c-modal-backdrop j-modal-backdrop" aria-label="Close dialog"></button>
  <section class="c-modal c-modal--confirm" role="dialog" aria-modal="true" aria-labelledby="j-confirm-delete-title">
    ...
    <h2 class="c-confirm-delete__title" id="j-confirm-delete-title"></h2>
    <p class="c-confirm-delete__description" id="j-confirm-delete-description"></p>
    <div class="c-confirm-delete__actions">
      <button type="button" class="c-btn-plain j-modal-close">Cancel</button>
      <button type="button" class="c-btn-danger" id="j-confirm-delete-confirm"></button>
    </div>
  </section>
</div>

<!-- MODAL: DELETE ACADEMIC STRUCTURE -->
<div class="c-modal-layer" id="j-modal-delete-structure" role="presentation">
  <button type="button" class="c-modal-backdrop j-modal-backdrop" aria-label="Close dialog"></button>
  <section class="c-modal c-modal--confirm c-modal--confirm-wide" role="dialog" aria-modal="true" aria-labelledby="j-delete-structure-title">
    <div class="c-confirm-delete__icon" aria-hidden="true">
    ...
    <h2 class="c-confirm-delete__title" id="j-delete-structure-title">Delete Academic Structures</h2>
    <p class="c-confirm-delete__description">Select the grade or the classes you wish to remove. They will accumulate as selected tags.</p>
    <div class="c-del-structure__body">
      <p class="c-del-structure__label">Grade option</p>
      <div id="j-del-grade-pill-wrap"></div>
      <p class="c-del-structure__label">Class options</p>
      <div class="c-del-structure__pills" id="j-del-class-pill-wrap"></div>
    </div>
    <div class="c-confirm-delete__actions">
      <button type="button" class="c-btn-plain j-modal-close">Cancel</button>
      <button type="button" class="c-btn-danger" id="j-del-structure-confirm" disabled>Delete Selected</button>
    </div>
  </section>
</div>
...
<script src="/assets/features/admin_academic/data.js"></script>
<script src="/assets/features/admin_academic/script.js"></script>
</body>
</html>
