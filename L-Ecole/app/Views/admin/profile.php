...
/**
 * =========================================================================
 * L'ÉCOLE — ADMIN PROFILE & SETTINGS VIEW
 * =========================================================================
 * Responsibility: Renders the Admin Profile & Settings interface.
 * Role: Admin (`/admin/profile`)
 * Architectural Precedent: 1:1 structural port from `Admin/profile/index.html`.
 */

$title = "L'École Admin Dashboard — My Profile & Settings";
$featureCss = "/assets/features/admin_profile/styles.css";
$currentRole = 'admin';
...
<div id="j-app-root" class="c-app-shell">
  ...
  <!-- MAIN CONTENT — PROFILE & SETTINGS PAGE -->
              ...
              <div class="c-profile-card__identity-row">
                <div class="c-profile-card__identity-group">
                  ...
                  <div class="c-profile-card__name-block">
                    ...
                    <p class="c-profile-card__role">Principal</p>
                  </div>
                </div>
          ...
          <section class="c-info-card" aria-labelledby="j-profile-information-heading">
            ...
            <dl class="c-info-grid">
              ...
              <div class="c-info-tile">
                ...
                <dd class="c-info-tile__value">principal@lecole.edu</dd>
              </div>
              <div class="c-info-tile">
                <dt class="c-info-tile__label">
                ...
                <dd class="c-info-tile__value">+94 77 245 1880</dd>
              </div>
              <div class="c-info-tile">
                <dt class="c-info-tile__label">
                  <span class="c-info-tile__label-icon" aria-hidden="true"><svg class="c-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg></span>
              ...
              <div class="c-info-tile">
                ...
                <dd class="c-info-tile__value">LEC-ADM-001</dd>
              </div>
            </dl>
          </section>

          <!-- SETTINGS GRID: General Information + Admin Security -->
          <div class="c-settings-grid">
            ...
            <section class="c-info-card" aria-labelledby="j-admin-security-heading">
              <div class="c-section-header">
                ...
                <div>
                  <h2 class="c-section-header__title c-font-display" id="j-admin-security-heading">Admin Security</h2>
...
<script src="/assets/features/admin_profile/script.js"></script>
</body>
</html>
