...
/**
 * =========================================================================
 * L'ÉCOLE — MANAGEMENT DASHBOARD VIEW
 * =========================================================================
 * Responsibility: Renders the Management Dashboard user interface.
 * Role: Management (`/management/dashboard`)
 * Architectural Precedent: 1:1 structural port from `Management Panel/dashboard/index.html`.
 */

$title = "L'École Management Dashboard Interface";
$featureCss = "/assets/features/management_dashboard/styles.css";
...
<script src="/assets/features/management_dashboard/data.js"></script>
<script src="/assets/features/management_dashboard/script.js"></script>
</body>
</html>
