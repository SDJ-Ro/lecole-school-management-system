...
(function () {
  ...
  const ICONS = {
    ...
    userCheck: '<path d="M16 11v6"/><path d="M19 14h-6"/><path d="M2 21a8 8 0 0 1 11.873-7"/><circle cx="10" cy="8" r="5"/>',
  ...
  function dpMonthLabel(date) { return new Intl.DateTimeFormat('en-GB', { month: 'long', year: 'numeric' }).format(date); }
  ...
  /* =====================================================================
     ...
     #/add-parent. Mirrors the <Routes> from App.tsx.
     ===================================================================== */
  ...
  function applyRoute() {
    ...
    if (route === 'people') {
      ...
      if (requestedTab === 'Teachers' || requestedTab === 'Parents') {
  ...
  function renderStudentsPanel() {
    ...
    return (
      ...
      '<div class="c-search-field">' + icon('search', 15, 'c-search-field-icon') + '<input type="text" class="c-search-input j-student-search" placeholder="Search students..." value="' + esc(State.studentQuery) + '" /></div>' +
      queueMount('filterselect', {
  ...
  function renderTeachersPanel() {
    ...
    return (
      ...
      '<div class="c-search-field">' + icon('search', 15, 'c-search-field-icon') + '<input type="text" class="c-search-input j-teacher-search" placeholder="Search teachers..." value="' + esc(State.teacherQuery) + '" /></div>' +
  ...
  function renderParentsPanel() {
    ...
    return (
      ...
      '<div class="c-panel-toolbar" style="background:' + theme.tint + ';">' +
      '<div class="c-panel-toolbar-row c-wrap-row">' +
      '<div class="c-search-field">' + icon('search', 15, 'c-search-field-icon') + '<input type="text" class="c-search-input j-parent-search" placeholder="Search parents..." value="' + esc(State.parentQuery) + '" /></div>' +
  ...
  function renderManagementPanel() {
    ...
    return (
      ...
      '<div class="c-panel-toolbar" style="background:' + theme.tint + ';">' +
      '<div class="c-panel-toolbar-row c-wrap-row">' +
      '<div class="c-search-field">' + icon('search', 15, 'c-search-field-icon') + '<input type="text" class="c-search-input j-management-search" placeholder="Search management..." value="' + esc(State.managementQuery) + '" /></div>' +
  ...
  function openProfileEditor(profile) { openProfile(profile, 'edit'); }
  ...
  /* =====================================================================
     16. ADD TEACHER / PARENT FORM PAGES
     Mirrors src/features/people/AddTeacher.tsx, AddParent.tsx.
     These follow the same shape, so a couple of
  ...
  const FORM_STATE_BAGS = { addTeacherForm: 'addTeacherForm', addParentForm: 'addParentForm' };
